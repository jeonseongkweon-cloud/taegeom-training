...
1. 처음 배우는 태권검도
2. 일반 수련 Level 1–10
3. 태권도 4단 이상 Fast Track
4. WTKF 공식 지도자 과정
5. 온라인 세미나·연수원
6. 지도자 보수교육

## 개발 원칙
**앞으로 새 버전은 기존 기능을 철거하지 않고 누적해서 확장합니다.**
...
- RTL layout supported for Arabic, Persian and Urdu.
- Official terminology room added for TAEGEOM-specific names.
- Existing v1.6/v1.4 training functions are preserved; this release adds internationalization rather than replacing the training system.
